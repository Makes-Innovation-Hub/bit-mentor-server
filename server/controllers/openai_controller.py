...
from server.utils.logger import logger, generate_request_id
...
async def generate_question(body: GenQuestionBody, response: Response):
    ...
    logger.info(f"Received request to generate question with body: {body.dict()}")
    ...
    try:
        ...
        logger.info(f"Successfully generated response: {result}")
